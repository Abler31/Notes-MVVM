...
import ru.company.notes.adapters.NotesAdapter;
import ru.company.notes.data.Note;
import ru.company.notes.viewmodels.NoteViewModel;

public class MainActivity extends AppCompatActivity {
    public static int ADD_NOTE_REQUEST = 1;
    public static int EDIT_NOTE_REQUEST = 2;
